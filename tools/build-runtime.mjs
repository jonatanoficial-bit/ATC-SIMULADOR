...
const manifest = {
  schema:1,
  architectureGeneration:62,
  strategy:'mobile-stability-hotfix-safe-mode-pace-sector-handoff-coordination-center-control-room-handoff-arrival-departure-sequencer-center-aman-dman-holding-dynamic-weather-atis-notam-center-radar-crosswind-world-airports-procedure-pack-center-airport-route-challenges-replay-timeline-heatmap-center-bookmarks-session-export-instructor-debrief-replay-analytics-center-feedback-training-campaign-progression-licenses-achievements-center-xp-ranks-scenario-mission-generator-center-missions-objectives-events-live-ops-remote-config-center-feature-flags-killswitch-pwa-update-cache-migration-center-version-guard-service-worker-stability-observatory-diagnostics-center-safe-mode-pwa-cache-adaptive-pace-workload-director-mobile-balance-cooldown-non-aeronautical-revenue-center-retail-dutyfree-parking-terminal-flow-landside-center-queues-security-checkin-cargo-logistics-operations-center-uld-dg-coldchain-freight-ground-handling-turnaround-center-gate-pushback-sla-radio-phraseology-vhf-readback-hearback-cpdlc-advanced-advanced-weather-ifr-vfr-surface-safety-director-ai-copilot-decision-support-center-recommendations-alerts-digital-twin-predictive-center-forecast-whatif-bottleneck-asset-maintenance-reliability-center-radar-ils-mtbf-mttr-security-cyber-defense-center-screening-perimeter-soc-emergency-response-disaster-center-arff-evacuation-medical-multi-airport-network-center-hubs-routes-slots-passenger-reputation-center-nps-complaints-public-image-workforce-staffing-center-roster-fatigue-training-revenue-management-commercial-center-financial-strategy-environment-sustainability-center-esg-noise-emissions-infrastructure-expansion-program-capex-maintenance-capacity-safety-compliance-center-sms-audit-corrective-actions-crisis-command-center-irregular-ops-airport-authority-terminal-ops-passenger-experience-airline-operations-center-sla-demand-international-campaign-contracts-seasons-training-coach-debriefing-adaptive-study-training-academy-certification-guided-missions-public-ops-feedback-telemetry-hotfix-post-publish-healthcheck-github-pages-pwa-hotfix-post-gold-master-real-device-qa-screenshots-github-pages-gold-master-packaging-final-store-pwa-player-manual-public-release-candidate-qa-final-balance-guided-tutorial-commercial-mobile-aaa-polish-responsive-hud-onboarding-local-async-control-room-ranking-shared-replay-international-network-flow-slots-connections-alternates-complex-operational-incidents-emergency-multiagency-airport-operational-economy-contracts-delay-costs-efficiency-deep-controller-career-licenses-ratings-fatigue-reputation-published-procedures-sid-star-ils-rnav-holdings-advanced-ifr-vfr-weather-realistic-airport-surface-graph-realistic-aircraft-performance-deterministic-replay-clock-professional-accessibility-settings-desktop-tablet-workspace-adaptive-mobile-ux-installable-offline-pwa-transactional-save-vault-quality-gated-typescript-modules',
